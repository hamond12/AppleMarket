...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initData() // 더미 데이터 추가
        setAdapter() // 어댑터 설정 및 상세 페이지 라우팅 구현
        fbAnimation() // 플로팅 버튼 애니메이션 구현
        pushNotification() // 푸쉬 알림 보내기 기능 구현
        this.onBackPressedDispatcher.addCallback(this, callback) // 뒤로가기 버튼 동작 구현
    }

    private fun initData(){
        dataList.add(Item(R.drawable.sample1, "산진 한달된 선풍기 팝니다","이사가서 필요가 없어졌어요 급하게 내놓습니다", "대현동",1000, "서울 서대문구 창천동", 13, 25, false))
        dataList.add(Item(R.drawable.sample2, "김치냉장고", "이사로인해 내놔요","안마담", 20000, "인천 계양구 귤현동", 8, 28, false))
